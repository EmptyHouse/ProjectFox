...
public class DebugSettings : MonoBehaviour
{
    ...
    public void SlowTimeForSeconds(float timeScale, float secondsToSlow)
    {
        StartCoroutine(SlowTimeCoroutine(timeScale, secondsToSlow));
    }

    private IEnumerator SlowTimeCoroutine(float timeScale, float realTimeSecondsToSlow)
    {
